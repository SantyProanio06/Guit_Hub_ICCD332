...
| *Comando* | *Descripción*                       | *Comando* | *Descripción*                            |
|-----------+-------------------------------------+-----------+------------------------------------------|
| ~C-e~     | Te transporta al final de una linea | ~M-e~     | Te lleva al final de un párrafo          |
| ~C-f~     | Te adelanta un carácter             | ~C-/~     | Deshace el ultimo cambio realizado       |
| ~C-p~     | Te mueve hacia la linea de arriba   | ~C-x-1~   | Elimina las ventanas que no están en uso |
...
[[./ImagesAriel/MontufarAriel-game1.jpeg]]
[[./ImagesAriel/MontufarAriel-game2.jpeg]]
[[./ImagesAriel/MontufarAriel-game3.jpeg]]
...
4. **Ariel Montufar:** <M-e>. <M-e runs the command org-forward-sentence (found in org-mode-map),
...
4. **Ariel Montufar:** <C-x-b>. C-x b runs the command switch-to-buffer (found in global-map), which
