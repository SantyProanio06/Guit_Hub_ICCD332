...
\endlastfoot
\hline
\texttt{C-e} & Te transporta al final de una linea & \texttt{M-e} & Te lleva al final de un párrafo\\[0pt]
\texttt{C-f} & Te adelanta un carácter & \texttt{C-/} & Deshace el ultimo cambio realizado\\[0pt]
\texttt{C-p} & Te mueve hacia la linea de arriba & \texttt{C-x-1} & Elimina las ventanas que no están en uso\\[0pt]
\end{longtable}
\subsection{Comandos Emacs Juego}
\label{sec:org3de1a74}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./ImagesAriel/MontufarAriel-game1.jpeg}
\end{center}
\begin{center}
\includegraphics[width=.9\linewidth]{./ImagesAriel/MontufarAriel-game2.jpeg}
\end{center}
\begin{center}
\includegraphics[width=.9\linewidth]{./ImagesAriel/MontufarAriel-game3.jpeg}
\end{center}

\subsection{Usando Emacs para tener Ayuda sobre Emacs}
\label{sec:org2a224b5}
...
\item \textbf{\textbf{Ariel Montufar:}} <M-e>. <M-e runs the command org-forward-sentence (found in org-mode-map),
\end{enumerate}
...
\item \textbf{\textbf{Ariel Montufar:}} <C-x-b>. C-x b runs the command switch-to-buffer (found in global-map), which
\end{enumerate}
is an interactive native-compiled Lisp function in  
\section{Equipo de Trabajo}
\label{sec:orgf190009}
